package org.hf.experi.extentreports;
...
import org.hf.experi.core.BaseTest;
...
public class ExtentReporter implements ITestListener{
	...
	public void screencapture(String testname) throws IOException {
		try {
			File scrfile = ((TakesScreenshot) BaseTest.getDriver()).getScreenshotAs(org.openqa.selenium.OutputType.FILE);
